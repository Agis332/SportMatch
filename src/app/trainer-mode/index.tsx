...
import { Calendar, ChevronRight, Clock, DollarSign, Dumbbell, MapPin, Star, Users } from 'lucide-react-native';
...
const STATS = [
  { label: "Today's sessions", value: '2',    icon: Calendar,   color: BLUE,      bg: '#EFF6FF', darkBg: '#1E3A5F', route: '/trainer-mode/sessions' },
        ...
        {TODAY_SESSIONS.map(session => (
          <TouchableOpacity
            ...
            <View style={styles.sessionBody}>
              <View style={[styles.clientAvatar, { backgroundColor: session.colorA }]}>
